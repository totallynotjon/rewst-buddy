...
export type AzureFunctionAppInterpreterDeploymentStreamEvent =
	| AzureFunctionAppInterpreterDeploymentStreamFailureResponse
	| AzureFunctionAppInterpreterDeploymentStreamMessage
	| AzureFunctionAppInterpreterDeploymentStreamSuccessResponse;
...
export type CloneFormStreamSuccessResponse = BaseCloneObjectSuccessResponse &
	BaseCloningResponse &
	BaseStreamEvent & {
...
export type CloneObjectStreamEvent =
	| CloneFormStreamSuccessResponse
	| CloneSiteStreamSuccessResponse
	| CloneTemplateStreamSuccessResponse
	| CloneWorkflowStreamSuccessResponse
	| CloningExportPhaseStreamFailureResponse
	| CloningExportPhaseStreamMessage
	| CloningImportPhaseStreamFailureResponse
	| CloningImportPhaseStreamMessage;
...
export type CloneSiteStreamSuccessResponse = BaseCloneObjectSuccessResponse &
	BaseCloningResponse &
	BaseStreamEvent & {
...
export type CloneTemplateStreamSuccessResponse = BaseCloneObjectSuccessResponse &
	BaseCloningResponse &
	BaseStreamEvent & {
...
export type CloneWorkflowStreamSuccessResponse = BaseCloneObjectSuccessResponse &
	BaseCloningResponse &
	BaseStreamEvent & {
...
export type CloningExportPhaseStreamFailureResponse = BaseCloningResponse &
	BaseStreamEvent &
	PhasedCloneEvent & {
...
export type CloningExportPhaseStreamMessage = BaseStreamEvent &
	ExportObjectsProgressMessage &
	PhasedCloneEvent & {
...
export type CloningImportPhaseStreamFailureResponse = BaseCloningResponse &
	BaseStreamEvent &
	PhasedCloneEvent & {
...
export type CloningImportPhaseStreamMessage = BaseStreamEvent &
...
export type ExportDownloadPhaseStreamFailureResponse = BaseCloningResponse &
	BaseStreamEvent &
	PhasedCloneEvent & {
...
export type ExportDownloadPhaseStreamMessage = BaseStreamEvent &
	PhasedCloneEvent & {
...
export type ExportObjectsStreamEvent =
	| ExportObjectsStreamFailureResponse
	| ExportObjectsStreamMessage
	| ExportObjectsStreamSuccessResponse;

export type ExportObjectsStreamFailureResponse = BaseStreamEvent &
	BaseStreamResponse & {
...
export type ExportObjectsStreamMessage = BaseStreamEvent &
	ExportObjectsProgressMessage & {
...
export type ExportObjectsStreamSuccessResponse = BaseStreamEvent &
	BaseStreamResponse & {
...
export type ImportBundleStreamEvent =
	| ImportBundleStreamMessage
	| ImportBundleStreamResponse
	| ImportBundleStreamResponseError;

export type ImportBundleStreamMessage = BaseStreamEvent &
	ImportProgressMessage & {
...
export type MicrosoftBundleAuthorizationRequestStreamEvent =
	| MicrosoftBundleAuthorizationStreamFailureResponse
	| MicrosoftBundleAuthorizationStreamMessage
	| MicrosoftBundleAuthorizationStreamSuccessResponse;
...
export type MicrosoftCspConsentRequestStreamEvent =
	| MicrosoftCspConsentStreamFailureResponse
	| MicrosoftCspConsentStreamMessage
	| MicrosoftCspConsentStreamSuccessResponse;

export type MicrosoftCspConsentStreamFailureResponse = BaseMicrosoftCspConsentResponse &
	BaseStreamEvent & {
...
export type MicrosoftCspConsentStreamMessage = BaseMicrosoftCspConsentResponse &
	BaseStreamEvent & {
...
export type MicrosoftCspConsentStreamSuccessResponse = BaseMicrosoftCspConsentResponse &
	BaseStreamEvent & {
...
export type ResendUserInviteEmailStreamEvent =
	| ResendUserInviteEmailStreamFailureResponse
	| ResendUserInviteEmailStreamSuccessResponse;
...
export type SynchronizeClonesImportPhaseStreamFailureMessage = BaseStreamEvent &
	PhasedCloneEvent & {
...
export type SynchronizeClonesStreamEvent =
	| CloningExportPhaseStreamFailureResponse
	| CloningExportPhaseStreamMessage
	| CloningImportPhaseStreamMessage
	| SynchronizeClonesImportPhaseStreamFailureMessage
	| SynchronizeClonesStreamResponse;

export type SynchronizeClonesStreamResponse = BaseCloningResponse &
	BaseStreamEvent & {
...
export type UnpackCrateStreamEvent =
	| CloningImportPhaseStreamFailureResponse
	| CloningImportPhaseStreamMessage
	| ExportDownloadPhaseStreamFailureResponse
	| ExportDownloadPhaseStreamMessage
	| UnpackCrateStreamSuccessResponse;

export type UnpackCrateStreamSuccessResponse = BaseCloneObjectSuccessResponse &
	BaseCloningResponse &
	BaseStreamEvent & {
...
export type TemplateFragment = {
	...
	context?: any | null;
	language: string;
	cloneOverrides?: any | null;
	clonedFromId?: string | null;
	isShared?: boolean | null;
	isSynchronized?: boolean | null;
	orgId: string;
	unpackedFromId?: string | null;
	createdAt: string;
	updatedAt: string;
	updatedById?: string | null;
	organization: { __typename?: 'Organization'; id?: string | null; name: string };
	tags: Array<{ __typename?: 'Tag'; id?: string | null; name?: string | null; color?: string | null }>;
	clonedFrom?: { __typename?: 'Template'; id: string; name: string } | null;
	updatedBy?: { __typename?: 'User'; id?: string | null; username?: string | null } | null;
	unpackedFrom?: { __typename?: 'Crate'; id: string; name: string } | null;
};
...
export type ListTemplatesMinimalQuery = {
	__typename?: 'Query';
	templates: Array<{
		__typename?: 'Template';
		id: string;
...
export type CreateTemplateMinimalMutation = {
	__typename?: 'Mutation';
	template?: {
		__typename?: 'Template';
		id: string;
...
export type UpdateTemplateBodyMutation = {
	__typename?: 'Mutation';
	template?: {
		__typename?: 'Template';
		id: string;
...
export type UpdateTemplateNameMutation = {
	__typename?: 'Mutation';
	template?: {
		__typename?: 'Template';
		id: string;
...
export type UserOrganizationQuery = {
	...
	userOrganization?: {
		...
		name: string;
		orgSlug?: string | null;
		resultsRetentionDays?: number | null;
		rocSiteId?: string | null;
		tid?: string | null;
		managedOrgs: Array<{ __typename?: 'Organization'; id?: string | null; name: string }>;
	} | null;
};
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
	return {
		listTemplatesMinimal(
			variables: ListTemplatesMinimalQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders,
			signal?: RequestInit['signal'],
		): Promise<ListTemplatesMinimalQuery> {
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<ListTemplatesMinimalQuery>({
						document: ListTemplatesMinimalDocument,
						variables,
		...
		UserOrganization(
			...
			requestHeaders?: GraphQLClientRequestHeaders,
			signal?: RequestInit['signal'],
		): Promise<UserOrganizationQuery> {
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<UserOrganizationQuery>({
