...
export function buildEngineeringDirective(availableTools: ReadonlySet<string>): string {
	const hasWorkflowTools = availableTools.has('rewst_workflow_get') || availableTools.has('rewst_workflow_edit');
