...
export function workflowEditOperationGrammar(): string {
	return [
		...
		'autolayout {section?} (recompute task positions; with section — a task name/id or array of them — only the smallest single-entry/single-exit chunk containing those tasks is re-arranged and the surrounding tasks shift to fit)',
