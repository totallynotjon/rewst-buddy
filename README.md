...
- `@rewst` chat participant — ask Rewst's AI assistant (RoboRewsty) questions right in VS Code's Chat view; it can read, search, and edit your workspace files and even browse the web (opt-in) to ground its answers
