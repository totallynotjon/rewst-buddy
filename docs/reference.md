...
| ------------------------------------------------ | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `rewst-buddy.regions`                            | `array`   | `[{"name":"North America","cookieName":"appSession","graphqlUrl":"https://api.rewst.io/graphql","loginUrl":"https://app.rewst.io"},{"name":"Asia","cookieName":"auAppSession","graphqlUrl":"https://api.rewst.asia/graphql","loginUrl":"https://app.rewst.asia"},{"name":"Europe","cookieName":"euAppSession","graphqlUrl":"https://api.rewst.eu/graphql","loginUrl":"https://app.rewst.eu"}]` | Regional configuration for different Rewst instances. See [Multi-Region Setup](#multi-region-setup).                                                                                                                                                                                                                                                                                                                                                                                                  |
...
North America, Asia, and Europe (DE) are built in. For other Rewst instances, configure custom regions in VS Code settings:
...
Each region entry requires `name`, `cookieName`, `graphqlUrl`, and `loginUrl`. An optional `subscriptionsUrl` sets the WebSocket endpoint used by the AI assistant; when omitted it is derived from `graphqlUrl` (e.g. `https://api.rewst.io/graphql` → `wss://api.rewst.io/subscriptions`). For the built-in Europe (DE) region, Jinja filter documentation uses `https://engine.rewst.eu` and subscriptions use `wss://api.rewst.eu/subscriptions`.
